...
public class Settings extends PreferenceActivity implements
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			intent = new Intent(this, BasicMapViewer.class);
	...
	public void onSharedPreferenceChanged(SharedPreferences preferences,String key) {
		if (BasicMapViewer.SETTING_SCALE.equals(key)) {
			float userScaleFactor = DisplayModel.getDefaultUserScaleFactor();
			float fs = Float.valueOf(preferences.getString(BasicMapViewer.SETTING_SCALE,Float.toString(userScaleFactor)));
			Log.e("onSharedPreferenceChanged","User ScaleFactor " + Float.toString(fs));
