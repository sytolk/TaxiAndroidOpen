...
public class AndroidPreferencesAPI8 implements PreferencesFacade {
    private SharedPreferences.Editor editor;
    private final SharedPreferences sharedPreferences;

    public AndroidPreferencesAPI8(SharedPreferences sharedPreferences) {
    ...
    public synchronized void save() {
        if (this.editor != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) this.editor.apply();
